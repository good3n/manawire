  ...
  <Layout>
    ...
    <LocationInfo>
      <div>
        ...
        <p>SEO changes from year to year. What is effective at one time can have negative effects later. In these last few years, SEO strategies have changes a lot. As a Clarkston SEO agency, we stay at the forefront of the traffic trends, helping you adapt to maintain your postitive ranking and increase your customers.</p>
        <p>Your Manawire SEO campaign will feature in-depth strategy, experienced execution, and total transparency in all phases of our work.</p>
        <p>Manawire is a Clarkston Search Engine Optimization (SEO) Company. We specialize in getting you in touch with your audience through Search Engine rankings. We will thoroughly review and audit your website, and that of your competition. We will then create an SEO roadmap that will outline our Search Engine Strategy that will propel your business to the top.</p>
        <p>Nestled in the middle of Oakland County Michigan lies Clarkston. Clarkston holds a special meaning to us. We eat at the Clarkston Union. We’ve seen our favorite bands at DTE Energy Music Theatre (Yes, we also will forever know it as Pine Knob). We grew up going to Depot Park after school. But most of all, it’s because we are lucky enough to call Clarkston our home.</p>
        <p>At Manawire, we provide our Clarkston Search Engine Optimization services to customers, clients, non-profits, and small businesses in and around Clarkston Michigan. How do we do it? Through SEO tactics like Keyword Research, Competitor Research, Building Local Citations, Generating Local Reviews, Social Media Management, and Content Marketing. We optimize Local Organic SEO so that your Clarkston customers can find you easier. Our Search Engine Optimization Services are affordable and create long lasting results. Our Search Engine Optimization is different from our competitors in Clarkston because we follow strict guidelines to get your website to the top. We create an SEO roadmap that allows you actually see the route we take to getting your website to the top of the Search Results.</p>
      </div>
      <div>
        <strong>It starts with an effective strategy.</strong>
        <p>An Effective SEO campaign requires an actionable plan and strategy. A technical understanding alone will not yeild an effective SEO campaign. We take the time and efford to create a customized approach to every one of our clients. This all beings with understanding your industry, and analyzing your competition.</p>
        <strong>It starts with an effective strategy.</strong>
        ...
        <strong>It starts with an effective strategy.</strong>
        <p>Think of the last time you sought out a product or service. If you're like most people, you probably used Search. Did you know that whatever business is listed in the first spot gets on average 33% of the search traffic? In fact, 60% of all search traffic goes right to the top 3 results listed. If you're not ranking on the first page then you are probably missing out completely.</p>
        <p>Connect with the top Clarkston SEO company. Whether you're looking for further information on Search Engine Optimization, currently running a campaign with another company and it's not yeilding the results you had expected, or questioning if SEO for your Clarkston business would help you.</p>
      </div>
    </LocationInfo>
    <Quote />
  </Layout>
